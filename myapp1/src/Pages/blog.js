...
import Delhi from '../Gallery/delhi.jpg'
  ...
  return (
    ...
    <h4 className='testimonials-blogs'>"Welcome To My Blogs" 💖</h4>
     <div className='boxes'>
        ...
        <div className='box-1'><img className='img-data-blog' src={Delhi} alt='img' /><h4 className='name-dataa'>Kolkata-Delhi Blog<ArrowOutwardSharpIcon /></h4></div>
